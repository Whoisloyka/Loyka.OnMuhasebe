...
using Loyka.OnMuhasebe.Birimler;
using Loyka.OnMuhasebe.Cariler;
using Loyka.OnMuhasebe.Consts;
using Loyka.OnMuhasebe.Depolar;
using Loyka.OnMuhasebe.Donemler;
...
using Loyka.OnMuhasebe.Masraflar;
...
namespace Loyka.OnMuhasebe.Cofigurations;
...
public static class OnMuhasebeDbContextModelBuilderExtensions
{
    ...
    //    builder.Entity<OdemeBelgesiDagilim>().HasNoKey();
    //}
}