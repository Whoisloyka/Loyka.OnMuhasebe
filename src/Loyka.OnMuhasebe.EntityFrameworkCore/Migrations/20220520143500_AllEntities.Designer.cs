...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.Bankalar.Masraf", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.Bankalar.Stok", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.Bankalar.Sube", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaSubeler.Birim", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaSubeler.Cari", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaSubeler.Depo", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaSubeler.Donem", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaSubeler.Fatura", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaHesaplar.BankaHesap", b =>
                {
                    ...
                    b.HasOne("Loyka.OnMuhasebe.Bankalar.Sube", "Sube")
                        .WithMany("BankaHesaplar")
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.Bankalar.Masraf", b =>
                {
                    b.HasOne("Loyka.OnMuhasebe.BankaSubeler.Birim", "Birim")
                        .WithMany("Masraflar")
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.BankaSubeler.Fatura", b =>
                {
                    b.HasOne("Loyka.OnMuhasebe.BankaSubeler.Cari", "Cari")
                        .WithMany("Faturalar")
                        .HasForeignKey("CariId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Loyka.OnMuhasebe.BankaSubeler.Donem", "Donem")
                        .WithMany("Faturalar")
            ...
            modelBuilder.Entity("Loyka.OnMuhasebe.Faturalar.FaturaHareket", b =>
                {
                    b.HasOne("Loyka.OnMuhasebe.BankaSubeler.Depo", "Depo")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("DepoId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Loyka.OnMuhasebe.BankaSubeler.Fatura", "Fatura")
                        .WithMany("FaturaHareketler")
                    ...
                    b.HasOne("Loyka.OnMuhasebe.Bankalar.Masraf", "Masraf")
                        .WithMany("FaturaHareketler")
                        .HasForeignKey("MasrafId")
                        .OnDelete(DeleteBehavior.NoAction);

                    b.HasOne("Loyka.OnMuhasebe.Bankalar.Stok", "Stok")
                        .WithMany("FaturaHareketler")
