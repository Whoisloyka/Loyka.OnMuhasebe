    ...
    public static void ConfigureBanka(this ModelBuilder builder)
    {
        builder.Entity<Banka>(b =>
        {
            ...
            b.HasOne(x => x.OzelKod1)
                ...
                .OnDelete(DeleteBehavior.NoAction); // kodun sahibi banka silinse dahi kodu silmeyip bir sonraki banka tanımında kodu kullanabilir.
    ...
    public static void ConfigureBankaSube(this ModelBuilder builder)
    {
        builder.Entity<BankaSube>(b =>
        {
            ...
            b.HasOne(x=>x.Banka)
                ...
                .OnDelete(DeleteBehavior.Cascade);// Cascade demek banka HardDelete ile silindiği zaman ona bağlı tüm şubeler de silinir. Ama bu uygulamada HardDelete ile silmeyeceğiz sadece isDeleted ile pasife alacağız.
            b.HasOne(x => x.OzelKod1)
            ...
            // Eğer Navigation Property tanımlamadıysanız domainde.
            // Bu şekilde burada da oluşturabilirsiniz.
            //b.HasOne<Banka>().WithMany().HasForeignKey(x => x.BankaId);
        });
    }
